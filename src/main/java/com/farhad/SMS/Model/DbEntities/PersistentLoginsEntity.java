 ...
 */
@Entity
@Table(name = "persistent_logins", schema = "sms", catalog = "")
public class PersistentLoginsEntity {
    ...
    protected PersistentLoginsEntity() {
    }

    public PersistentLoginsEntity(String username, String series, String token) {
